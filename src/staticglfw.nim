# Generated @ 2021-05-22T08:02:45-06:00
...
type
  ...
  ErrorFun* = proc (errorCode: cint; description: cstring) {.cdecl.} ##
    ...
    ## @ingroup init
    ##
  WindowPosFun* = proc (window: Window; xpos: cint; ypos: cint) {.cdecl.} ##
  ...
  WindowRefreshFun* = proc (window: Window) {.cdecl.} ##
    ...
    ## @ingroup window
    ##
  WindowFocusFun* = proc (window: Window; focused: bool) {.cdecl.} ##
    ...
    ## @ingroup window
    ##
  WindowIconifyFun* = proc (window: Window; iconified: bool) {.cdecl.} ##
    ...
    ## @ingroup window
    ##
  WindowMaximizeFun* = proc (window: Window; maximized: bool) {.cdecl.} ##
  ...
  MouseButtonFun* = proc (window: Window; button: cint; action: cint; modifiers: cint) {.cdecl.} ##
    ...
    ## @ingroup input
    ##
  CursorPosFun* = proc (window: Window; xpos: cdouble; ypos: cdouble) {.cdecl.} ##
    ...
    ## @ingroup input
    ##
  CursorEnterFun* = proc (window: Window; entered: bool) {.cdecl.} ##
  ...
  KeyFun* = proc (window: Window; key: cint; scancode: cint; action: cint; modifiers: cint) {.cdecl.} ##
    ...
    ## @ingroup input
    ##
  CharFun* = proc (window: Window; codepoint: cuint) {.cdecl.} ##
    ...
    ## @ingroup input
    ##
  CharModsFun* = proc (window: Window; codepoint: cuint; modifiers: cint) {.cdecl.} ##
    ...
    ## @ingroup input
    ##
  DropFun* = proc (window: Window; pathCount: cint; paths: cstringArray) {.cdecl.} ##
    ...
    ## @ingroup input
    ##
  MonitorFun* = proc (window: Monitor; event: cint) {.cdecl.} ##
    ...
    ## @ingroup monitor
    ##
  JoystickFun* = proc (jid: cint; event: cint) {.cdecl.} ##
  ...
  GammaRamp* = object  ## ```
    ...
    ##     @ingroup monitor
    ## ```
    red*: ptr UncheckedArray[cushort]  ## ```
      ##   ! An array of value describing the response of the red channel.
      ## ```
    green*: ptr UncheckedArray[cushort]  ## ```
      ##   ! An array of value describing the response of the green channel.
      ## ```
    blue*: ptr UncheckedArray[cushort]  ## ```
  ...
  Image* = object  ## ```
    ...
    height*: cint  ## ```
      ...
      ## ```
    pixels*: ptr UncheckedArray[cuchar]  ## ```
...
proc getVersionString*(): cstring {.importc: "glfwGetVersionString", cdecl.}
  ...
  ##     @ingroup init
  ## ```
proc getError*(description: ptr cstring): cint {.importc: "glfwGetError", cdecl, discardable.}
  ## ```
...
proc setErrorCallback*(callback: ErrorFun): ErrorFun {.
    importc: "glfwSetErrorCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup init
  ## ```
proc getMonitors*(count: ptr cint): ptr UncheckedArray[Monitor] {.
    importc: "glfwGetMonitors", cdecl.}
  ## ```
  ...
  ##     @ingroup monitor
  ## ```
proc getPrimaryMonitor*(): Monitor {.importc: "glfwGetPrimaryMonitor", cdecl.}
  ## ```
...
proc getMonitorPos*(monitor: Monitor; xpos: ptr cint; ypos: ptr cint) {.
  ...
  ##     @ingroup monitor
  ## ```
proc getMonitorWorkarea*(monitor: Monitor; xpos: ptr cint; ypos: ptr cint;
  ...
  ##     @ingroup monitor
  ## ```
proc getMonitorPhysicalSize*(monitor: Monitor; widthMM: ptr cint;
                             heightMM: ptr cint) {.
  ...
  ##     @ingroup monitor
  ## ```
proc getMonitorContentScale*(monitor: Monitor; xscale: ptr cfloat;
                             yscale: ptr cfloat) {.
...
proc getMonitorName*(monitor: Monitor): cstring {.
    importc: "glfwGetMonitorName", cdecl.}
  ## ```
  ...
  ##     @ingroup monitor
  ## ```
proc setMonitorUserPointer*(monitor: Monitor; p: pointer) {.
...
proc setMonitorCallback*(callback: MonitorFun): MonitorFun {.
    importc: "glfwSetMonitorCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup monitor
  ## ```
proc getVideoModes*(monitor: Monitor; count: ptr cint): ptr UncheckedArray[VideoMode] {.
  ...
  ##     @ingroup monitor
  ## ```
proc getVideoMode*(monitor: Monitor): ptr VideoMode {.
    importc: "glfwGetVideoMode", cdecl.}
  ## ```
  ...
  ##     @ingroup monitor
  ## ```
proc setGamma*(monitor: Monitor; gamma: cfloat) {.importc: "glfwSetGamma",
    cdecl.}
  ## ```
  ...
  ##     @ingroup monitor
  ## ```
proc getGammaRamp*(monitor: Monitor): ptr GammaRamp {.
    importc: "glfwGetGammaRamp", cdecl.}
  ## ```
  ...
  ##     @ingroup monitor
  ## ```
proc setGammaRamp*(monitor: Monitor; ramp: ptr GammaRamp) {.
...
proc windowHint*(hint: cint; value: cint) {.importc: "glfwWindowHint", cdecl.}
  ...
  ##     @ingroup window
  ## ```
proc windowHintString*(hint: cint; value: cstring) {.
    importc: "glfwWindowHintString", cdecl.}
  ## ```
  ##   ! @brief Sets the specified window hint to the desired value.
  ##
  ##     This function sets hints for the next call to @ref glfwCreateWindow.  The
...
proc createWindow*(width: cint; height: cint; title: cstring;
    ...
    importc: "glfwCreateWindow", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc destroyWindow*(window: Window) {.importc: "glfwDestroyWindow", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc windowShouldClose*(window: Window): cint {.
    importc: "glfwWindowShouldClose", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc setWindowShouldClose*(window: Window; value: cint) {.
...
proc setWindowTitle*(window: Window; title: cstring) {.
  ...
  ##     @ingroup window
  ## ```
proc setWindowIcon*(window: Window; count: cint; images: ptr UncheckedArray[Image]) {.
...
proc getWindowPos*(window: Window; xpos: ptr cint; ypos: ptr cint) {.
  ...
  ##     @ingroup window
  ## ```
proc setWindowPos*(window: Window; xpos: cint; ypos: cint) {.
...
proc getWindowSize*(window: Window; width: ptr cint; height: ptr cint) {.
  ...
  ##     @ingroup window
  ## ```
proc setWindowSizeLimits*(window: Window; minwidth: cint; minheight: cint;
  ...
  ##     @ingroup window
  ## ```
proc setWindowAspectRatio*(window: Window; numer: cint; denom: cint) {.
...
proc setWindowSize*(window: Window; width: cint; height: cint) {.
  ...
  ##     @ingroup window
  ## ```
proc getFramebufferSize*(window: Window; width: ptr cint; height: ptr cint) {.
  ...
  ##     @ingroup window
  ## ```
proc getWindowFrameSize*(window: Window; left: ptr cint; top: ptr cint;
  ...
  ##     @ingroup window
  ## ```
proc getWindowContentScale*(window: Window; xscale: ptr cfloat;
                            yscale: ptr cfloat) {.
...
proc getWindowOpacity*(window: Window): cfloat {.
    importc: "glfwGetWindowOpacity", cdecl.}
  ## ```
...
proc setWindowOpacity*(window: Window; opacity: cfloat) {.
  ...
  ##     @ingroup window
  ## ```
proc iconifyWindow*(window: Window) {.importc: "glfwIconifyWindow", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc restoreWindow*(window: Window) {.importc: "glfwRestoreWindow", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc maximizeWindow*(window: Window) {.importc: "glfwMaximizeWindow", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc showWindow*(window: Window) {.importc: "glfwShowWindow", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc hideWindow*(window: Window) {.importc: "glfwHideWindow", cdecl.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc focusWindow*(window: Window) {.importc: "glfwFocusWindow", cdecl.}
  ## ```
...
proc getWindowMonitor*(window: Window): Monitor {.
  ...
  ##     @ingroup window
  ## ```
proc setWindowMonitor*(window: Window; monitor: Monitor; xpos: cint;
                       ypos: cint; width: cint; height: cint; refreshRate: cint) {.
  ...
  ##     @ingroup window
  ## ```
proc getWindowAttrib*(window: Window; attrib: cint): cint {.
  ...
  ##     @ingroup window
  ## ```
proc setWindowAttrib*(window: Window; attrib: cint; value: cint) {.
  ...
  ##     @ingroup window
  ## ```
proc setWindowUserPointer*(window: Window; p: pointer) {.
...
proc getWindowUserPointer*(window: Window): pointer {.
  ...
  ##     @ingroup window
  ## ```
proc setWindowPosCallback*(window: Window; callback: WindowPosFun): WindowPosFun {.
    importc: "glfwSetWindowPosCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc setWindowSizeCallback*(window: Window; callback: WindowSizeFun): WindowSizeFun {.
    importc: "glfwSetWindowSizeCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc setWindowCloseCallback*(window: Window; callback: WindowCloseFun): WindowCloseFun {.
    importc: "glfwSetWindowCloseCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc setWindowRefreshCallback*(window: Window; callback: WindowRefreshFun): WindowRefreshFun {.
    importc: "glfwSetWindowRefreshCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc setWindowFocusCallback*(window: Window; callback: WindowFocusFun): WindowFocusFun {.
    importc: "glfwSetWindowFocusCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc setWindowIconifyCallback*(window: Window; callback: WindowIconifyFun): WindowIconifyFun {.
    importc: "glfwSetWindowIconifyCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup window
  ## ```
proc setWindowMaximizeCallback*(window: Window; callback: WindowMaximizeFun): WindowMaximizeFun {.
    importc: "glfwSetWindowMaximizeCallback", cdecl, discardable.}
  ## ```
...
proc setFramebufferSizeCallback*(window: Window;
                                 callback: FrameBufferSizeFun): FrameBufferSizeFun {.
    importc: "glfwSetFramebufferSizeCallback", cdecl, discardable.}
  ## ```
...
proc setWindowContentScaleCallback*(window: Window;
    ...
    importc: "glfwSetWindowContentScaleCallback", cdecl, discardable.}
  ## ```
...
proc waitEvents*() {.importc: "glfwWaitEvents", cdecl.}
  ...
  ##     @ingroup window
  ## ```
proc waitEventsTimeout*(timeout: cdouble) {.importc: "glfwWaitEventsTimeout",
    cdecl.}
  ## ```
...
proc postEmptyEvent*() {.importc: "glfwPostEmptyEvent", cdecl.}
  ...
  ##     @ingroup window
  ## ```
proc getInputMode*(window: Window; mode: cint): cint {.
    importc: "glfwGetInputMode", cdecl.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setInputMode*(window: Window; mode: cint; value: cint) {.
  ...
  ##     @ingroup input
  ## ```
proc rawMouseMotionSupported*(): cint {.importc: "glfwRawMouseMotionSupported",
                                        cdecl.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc getKeyName*(key: cint; scancode: cint): cstring {.
    importc: "glfwGetKeyName", cdecl.}
  ## ```
...
proc getKeyScancode*(key: cint): cint {.importc: "glfwGetKeyScancode", cdecl.}
  ...
  ##     @ingroup input
  ## ```
proc getKey*(window: Window; key: cint): cint {.importc: "glfwGetKey", cdecl.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc getMouseButton*(window: Window; button: cint): cint {.
...
proc setCursor*(window: Window; cursor: CursorHandle) {.
  ...
  ##     @ingroup input
  ## ```
proc setKeyCallback*(window: Window; callback: KeyFun): KeyFun {.
    importc: "glfwSetKeyCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setCharCallback*(window: Window; callback: CharFun): CharFun {.
    importc: "glfwSetCharCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setCharModsCallback*(window: Window; callback: CharModsFun): CharModsFun {.
    importc: "glfwSetCharModsCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setMouseButtonCallback*(window: Window; callback: MouseButtonFun): MouseButtonFun {.
    importc: "glfwSetMouseButtonCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setCursorPosCallback*(window: Window; callback: CursorPosFun): CursorPosFun {.
    importc: "glfwSetCursorPosCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setCursorEnterCallback*(window: Window; callback: CursorEnterFun): CursorEnterFun {.
    importc: "glfwSetCursorEnterCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setScrollCallback*(window: Window; callback: ScrollFun): ScrollFun {.
    importc: "glfwSetScrollCallback", cdecl, discardable.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setDropCallback*(window: Window; callback: DropFun): DropFun {.
    importc: "glfwSetDropCallback", cdecl, discardable.}
  ## ```
...
proc joystickPresent*(jid: cint): cint {.importc: "glfwJoystickPresent", cdecl.}
  ...
  ##     @ingroup input
  ## ```
proc getJoystickAxes*(jid: cint; count: ptr cint): ptr UncheckedArray[cfloat] {.
  ...
  ##     @ingroup input
  ## ```
proc getJoystickButtons*(jid: cint; count: ptr cint): ptr UncheckedArray[cuchar] {.
  ...
  ##     @ingroup input
  ## ```
proc getJoystickHats*(jid: cint; count: ptr cint): ptr UncheckedArray[cuchar] {.
  ...
  ##     @ingroup input
  ## ```
proc getJoystickName*(jid: cint): cstring {.importc: "glfwGetJoystickName",
    cdecl.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc getJoystickGUID*(jid: cint): cstring {.importc: "glfwGetJoystickGUID",
    cdecl.}
  ## ```
  ...
  ##     @ingroup input
  ## ```
proc setJoystickUserPointer*(jid: cint; p: pointer) {.
...
proc getJoystickUserPointer*(jid: cint): pointer {.
  ...
  ##     @ingroup input
  ## ```
proc joystickIsGamepad*(jid: cint): cint {.importc: "glfwJoystickIsGamepad",
    cdecl.}
  ## ```
...
proc setJoystickCallback*(callback: JoystickFun): JoystickFun {.
    importc: "glfwSetJoystickCallback", cdecl, discardable.}
  ## ```
...
proc makeContextCurrent*(window: Window) {.
    importc: "glfwMakeContextCurrent", cdecl.}
  ## ```
  ...
  ##     @ingroup context
  ## ```
proc getCurrentContext*(): Window {.importc: "glfwGetCurrentContext", cdecl.}
  ## ```
  ...
  ##     @ingroup context
  ## ```
proc swapBuffers*(window: Window) {.importc: "glfwSwapBuffers", cdecl.}
  ## ```
...
proc extensionSupported*(extension: cstring): cint {.
  ...
  ##     @ingroup context
  ## ```
proc getProcAddress*(procname: cstring): Glproc {.importc: "glfwGetProcAddress",
    cdecl.}
  ## ```
